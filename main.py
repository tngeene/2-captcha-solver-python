...
def launch_selenium(response):
    if response:
        print('Captcha Solved! Launching Browser...')
        # initiate chrome webdriver 
        # * check configs for firefox and others in https://selenium-python.readthedocs.io/installation.html#drivers
        ...
        driver.find_element(By.ID, 'email').send_keys('tngeene@captcha.com')
        driver.find_element(By.ID, 'comment-content').send_keys('test comment')
